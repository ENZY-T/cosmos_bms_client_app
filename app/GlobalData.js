...
// const topicEnvModifier = '-dev';
const topicEnvModifier = '';

export const GlobalData = {
  styles: styles,
  communicationSettings: {
    alertTopic: 'bms-state-alert' + topicEnvModifier,
    dataTopic: 'bms-state-data' + topicEnvModifier,
    confirmationTopic: 'bms-operation-confirmation' + topicEnvModifier,
    lampStateTopic: 'bms-lamp-state' + topicEnvModifier,
  },
  credentials: {},
  groundFloorSensors: [
